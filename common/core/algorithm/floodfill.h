...
public:
    ...
    * @param front_wall Whether a wall is detected in front
    * @param right_wall Whether a wall is detected on the right
    * @param left_wall Whether a wall is detected on the left
    */

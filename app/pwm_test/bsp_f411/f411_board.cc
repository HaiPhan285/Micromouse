...
Stmf4::StGpioSettings pwm_output_settings{Stmf4::GpioMode::AF, Stmf4::GpioOtype::PUSH_PULL,
                                          Stmf4::GpioOspeed::LOW, Stmf4::GpioPupd::NO_PULL,
                                          2}; // AF2 for TIM3 on PB4
...
const Stmf4::StPwmParams pwm_params{TIM3, Stmf4::PwmChannel::CH1, pwm_settings, 16000000};

...
namespace MM {
namespace Stmf4 {
StGpioSettings ir_led_settings{GpioMode::GPOUT, GpioOtype::PUSH_PULL, GpioOspeed::MEDIUM,
                               GpioPupd::NO_PULL, 0};
...
StGpioSettings tx_settings{GpioMode::AF, GpioOtype::PUSH_PULL, GpioOspeed::LOW, GpioPupd::NO_PULL,
                           7};

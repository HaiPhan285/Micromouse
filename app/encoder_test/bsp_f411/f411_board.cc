...
Stmf4::StGpioSettings encoder_gpio_settings{Stmf4::GpioMode::AF, Stmf4::GpioOtype::PUSH_PULL,
                                            Stmf4::GpioOspeed::HIGH, Stmf4::GpioPupd::PULL_UP, 1};

const Stmf4::StGpioParams enc_input_params_1{0, GPIOA, encoder_gpio_settings}; // PA0 channel A
const Stmf4::StGpioParams enc_input_params_2{1, GPIOA, encoder_gpio_settings}; // PA1 Channel B

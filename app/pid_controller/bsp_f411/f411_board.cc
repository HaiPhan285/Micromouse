...
StGpioSettings motor_pwm_settings{GpioMode::AF, GpioOtype::PUSH_PULL, GpioOspeed::LOW,
                                  GpioPupd::NO_PULL, 1};

StGpioSettings enc_input_settings{GpioMode::AF, GpioOtype::PUSH_PULL, GpioOspeed::LOW,
                                  GpioPupd::PULL_UP, 2};

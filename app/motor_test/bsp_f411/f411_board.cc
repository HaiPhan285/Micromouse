...
Stmf4::StGpioSettings enc_input_settings{Stmf4::GpioMode::AF, Stmf4::GpioOtype::PUSH_PULL,
                                         Stmf4::GpioOspeed::LOW, Stmf4::GpioPupd::PULL_UP, 2};

Stmf4::StPwmSettings pwm_settings{Stmf4::PwmMode::EDGE_ALIGNED, Stmf4::PwmOutputMode::PWM_MODE_1,
                                  Stmf4::PwmDir::UPCOUNTING};

Stmf4::StEncoderSettings encoder_settings{Stmf4::EncMode::MODE_3, Stmf4::EncChannel::BOTH,
...
const Stmf4::StGpioParams in1_params{2, GPIOA,
                                     motor_pwm_settings}; // PA2 for Motor IN1/PWM1 (TIM2_CH3)
const Stmf4::StGpioParams in2_params{3, GPIOA,
                                     motor_pwm_settings}; // PA3 for Motor IN2/PWM2 (TIM2_CH4)

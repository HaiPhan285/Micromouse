...
typedef struct {
    ...
    volatile uint32_t JOFR1;     /* ADC injected offset register 1,    offset: 0x14 */
    volatile uint32_t JOFR2;     /* ADC injected offset register 2,    offset: 0x18 */
    volatile uint32_t JOFR3;     /* ADC injected offset register 3,    offset: 0x1C */
    volatile uint32_t JOFR4;     /* ADC injected offset register 4,    offset: 0x20 */
